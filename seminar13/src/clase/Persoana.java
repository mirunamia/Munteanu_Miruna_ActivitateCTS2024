...
public class Persoana implements IPersoana{
    ...
    public int getVarsta() {
        ...
        if(CNP.charAt(0) == '1' || CNP.charAt(0) == '2') {
            an = (1900 + Integer.parseInt("" + CNP.charAt(1)) * 10 + Integer.parseInt("" + CNP.charAt(2)));
        }
        if(CNP.charAt(0) == '3' || CNP.charAt(0) == '4') {
            an = (1800 + Integer.parseInt("" + CNP.charAt(1)) * 10 + Integer.parseInt("" + CNP.charAt(2)));
        }
        if(CNP.charAt(0) == '5' || CNP.charAt(0) == '6') {
            an = (2000 + Integer.parseInt("" + CNP.charAt(1)) * 10 + Integer.parseInt("" + CNP.charAt(2)));
        }
    ...
    public boolean checkCNP() {
        ...
        if(CNP.length() > 13) {
            throw new IllegalArgumentException("CNP-ul este prea scurt.");
        }
